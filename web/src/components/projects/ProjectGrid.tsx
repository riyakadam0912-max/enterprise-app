...
export function ProjectGrid({ projects, selectedProjectId, onSelect }: { projects: Project[]; selectedProjectId: number | null; onSelect: (id: number) => void }) {
